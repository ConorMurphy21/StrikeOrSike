export default {
  ...
  activeMatchingMessage:
    "{player} is trying to {type} with {response} Do you have a match?",
  passiveDisputeMessage:
    "Your friends are deciding if {response} fits the category",
  ...
  about: {
    ...
    header: "About",
    project:
      'Strike or Sike has been a passion project of mine. Throughout the pandemic, game room sites, like this one, kept my friends and family entertained. Since I couldn\'t find one of my favourite games "Hit or Miss" anywhere, I decided to make it myself.',
    openSource:
      "This project is completely open source and can be found on {github}. If you want to contribute –  add a new feature, fix a bug, support a new language, or add more prompt packs –  feel free to submit a pull request. If you see a bug or want a feature (but aren’t as technically inclined) you can submit an {issues} or email us at {gmail}.",
